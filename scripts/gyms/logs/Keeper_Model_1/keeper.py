...
class GoalkeeperEnv(gym.Env):
    ...
    def spawn_ball(self):
        ...
        ball_velocity = (
            math.cos(math.radians(orientation)) * random.uniform(13.5, 16),
            math.sin(math.radians(orientation)) * random.uniform(13.5, 16),
...
# Train start:    04/01/2025 22:02:48
# Train end:      04/01/2025 23:45:30
# Train duration: 1:42:42