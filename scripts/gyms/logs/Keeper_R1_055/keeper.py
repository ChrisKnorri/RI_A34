    ...
    def step(self, action):
        ...
        if action not in [0, 5]:
            ...
            if self.step_counter <= BALL_STARTS_ITER:
                ...
                #self.calculate_orientation(self.get_bal_pos())
            print(f"walking to -14,1")
            self.player.behavior.execute("Walk",(-14, 1) , True, 0, True,
        ...
        if self.step_counter % 10 == 0:
            print(f"Step {self.step_counter}: action : {action}, reward : {reward}, ready: {self.ready}" )
